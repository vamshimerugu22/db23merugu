...
router.get('/', function (req, res) { 
    res.render('index', { title: 'pancake App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'pancake App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'pancake App Login', user : req.user }); 
}); 
